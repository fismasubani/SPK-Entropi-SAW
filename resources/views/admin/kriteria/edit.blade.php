        ...
        <div class="col-md-4">
            <div class="card shadow mb-4">
                ...
                <a href="#tambahkriteria" class="d-block card-header py-3" data-toggle="collapse"
                    ...
                    <h5 class="m-0 font-weight-bold text-primary">Edit Kriteria {{ $kriteria->nama_kriteria }}</h5>
                </a>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('kriteria.update', $kriteria->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_kriteria') is invalid @enderror" name="bobot" value="{{ $kriteria->bobot }}">
